...
if __name__ == '__main__':
    ...
    def save_comments(musics, flag, connection0):
        for i in musics:
            ...
            try:
                ...
                if comments['total'] > 0:
                    mysql.insert_comments(my_music_id, comments['total'], str(comments), connection0)
            except Exception as e:
                print my_music_id
                print e
                time.sleep(5)

    music_before = mysql.get_before_music()
    ...
    t2 = threading.Thread(target=save_comments, args=(music_before, True, connection2))
    t1.start()
    t2.start()